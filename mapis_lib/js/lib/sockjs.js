...
// 'unload' is deprecated by Permissions Policy in modern browsers.
// Use 'pagehide' instead, which fires at the same timing and supports bfcache.
if (!isChromePackagedApp) {
  module.exports.attachEvent('pagehide', unloadTriggered);
}
