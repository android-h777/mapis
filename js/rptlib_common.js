...
function rlOpenPop(code, params){
	...
	var W=Math.min(1320, screen.availWidth-40), H=Math.min(920, screen.availHeight-60);
...
/* ════════════════════════════════════════════════════════════
   ...
   레코드 {code,title,author,bu,idx,type,status,when,hint,gates,kw,abstract,mine}
     ...
     gates  : {itar,jda,named,external} → rptlib_review.js deriveClass로 class 도출(저장 안 함)
...
var RL_SUBS=[
	...
	{code:'KR-26-01', title:'Low-Temperature Cure Silicone for Flexible Display', author:'S.Y. Park',     bu:'Electronic Materials', when:'2h ago', status:'pending',  hint:'Tied to an active JDA — please confirm scope.', gates:{itar:0,jda:1,named:0,external:0}, mine:false},
	{code:'LEV-26-03',title:'Bio-based Silicone Feasibility Study (JDA)',          author:'Dr. Stephan Boß', bu:'Industrial',           when:'5h ago', status:'pending',  hint:'Access limited to named individuals.',          gates:{itar:0,jda:1,named:1,external:0}, mine:false},
	{code:'SH-26-02', title:'Defoamer Performance in Architectural Coatings',      author:'Wei Zhang',       bu:'Coatings',             when:'1d ago', status:'pending',  hint:'',                                              gates:{itar:0,jda:0,named:0,external:0}, mine:false},
	{code:'ABD-26-04',title:'Specialty Fluids for Personal Care Formulations',     author:'J. Whitfield',    bu:'Personal Care',        when:'3d ago', status:'approved', hint:'',                                              gates:{itar:0,jda:0,named:0,external:1}, mine:false},
	{code:'ITC-26-02',title:'Antifoam Improvement Project — Phase 2',              author:'Indumathi M.',    bu:'Industrial',           when:'1w ago', status:'rejected', hint:'', reviewNote:'Plant-trial data incomplete — add Phase-2 results and resubmit.', gates:{itar:0,jda:0,named:0,external:0}, mine:false},
	// ── 내 제출물 시드(mine:true) ──
	{code:'KR-26-00', title:'OLED Encapsulation Adhesive — Scale-up',              author:RL_ME, bu:'Electronic Materials', when:'2 days ago', status:'pending',  hint:'', gates:{itar:0,jda:0,named:0,external:0}, mine:true},
	{code:'SH-25-44', title:'Defoamer Screening for Decorative Coatings',          author:RL_ME, bu:'Coatings',             when:'last week',  status:'approved', hint:'', gates:{itar:0,jda:0,named:0,external:0}, mine:true},
	{code:'TT-26-02', title:'Silane Coupling Agent Optimization',                  author:RL_ME, bu:'Tire & Silanes',       when:'3 days ago', status:'rejected', hint:'', reviewNote:'Out of scope — ITAR-adjacent; route to the controlled repository.', gates:{itar:1,jda:0,named:0,external:0}, mine:true},
	{code:'KR-25-31', title:'UV-Curable Frontsheet Adhesion Study',                author:RL_ME, bu:'Electronic Materials', when:'2 months ago', status:'approved', hint:'', gates:{itar:0,jda:0,named:0,external:0}, mine:true},
	{code:'KR-24-07', title:'Thermal Interface Material — Field Reliability',      author:RL_ME, bu:'Electronic Materials', when:'last year',   status:'approved', hint:'', gates:{itar:0,jda:1,named:0,external:0}, mine:true}
];
